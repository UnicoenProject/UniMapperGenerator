package net.unicoen.ui.highlighting
...
import static net.unicoen.ui.highlighting.AntlrHighlightingConfiguration.*
...
class UniHighlightingCalculator implements ISemanticHighlightingCalculator {
	...
	var LANG = #{
		"python2" -> #[
			...
			LANG_KEYWORD -> Pattern.compile(
				"(" + newHashSet("and", "del", "from", "not", "while", "as", "elif", "global", "or", "with",
