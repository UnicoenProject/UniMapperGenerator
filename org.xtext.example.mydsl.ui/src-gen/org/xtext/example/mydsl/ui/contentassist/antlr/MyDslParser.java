		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getModelAccess().getGenAssignment_1(), "rule__Model__GenAssignment_1");
					put(grammarAccess.getModelAccess().getRulesAssignment_2(), "rule__Model__RulesAssignment_2");
					put(grammarAccess.getGrammarAccess().getGnameAssignment_1(), "rule__Grammar__GnameAssignment_1");
					put(grammarAccess.getGenerateAccess().getGenetoolAssignment_1(), "rule__Generate__GenetoolAssignment_1");
					put(grammarAccess.getRuleAccess().getNameAssignment_0(), "rule__Rule__NameAssignment_0");
					put(grammarAccess.getRuleAccess().getCountAssignment_1_1(), "rule__Rule__CountAssignment_1_1");
